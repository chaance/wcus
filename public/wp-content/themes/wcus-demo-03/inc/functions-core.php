...
function setup() : void {
	...
	$hook( 'action', 'admin_enqueue_scripts', 'admin_scripts', 10, 1 );
	$hook( 'action', 'admin_enqueue_scripts', 'admin_styles', 10, 1 );
...
function admin_scripts( $hook ) {
	wp_register_script( 'admin', get_asset_url( 'js', 'admin' ), [ 'jquery' ], get_asset_version( 'js', 'admin' ), true );
	if ( $hook === 'post-new.php' || $hook === 'post.php' ) {
		wp_enqueue_script( 'editor', get_asset_url( 'js', 'editor' ), [ 'jquery' ], get_asset_version( 'js', 'editor' ), true );
	}
}
...
function admin_styles( $hook ) {
	wp_enqueue_style( 'admin', get_asset_url( 'css', 'admin' ), [], get_asset_version( 'css', 'admin' ) );
	if ( $hook === 'post-new.php' || $hook === 'post.php' ) {
		wp_enqueue_style( 'editor', get_asset_url( 'css', 'editor' ), [], get_asset_version( 'css', 'editor' ) );
	}
}
