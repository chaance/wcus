...
namespace Chance_Digital\WCUS_Demo\Theme\Admin;

use function Chance_Digital\WCUS_Demo\Theme\Util\get_frontend_origin;

add_filter( 'wp_terms_checklist_args', __NAMESPACE__ . '\\taxonomy_checklist_checked_ontop_filter' );
add_filter( 'preview_post_link',       __NAMESPACE__ . '\\set_headless_preview_link' );
add_filter( 'rest_prepare_post',       __NAMESPACE__ . '\\set_preview_link_in_rest_response', 10, 2 );
add_filter( 'rest_prepare_page',       __NAMESPACE__ . '\\set_preview_link_in_rest_response', 10, 2 );
