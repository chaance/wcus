...
require_once WCUS_DEMO_INC . 'functions-autoload.php';
require_once WCUS_DEMO_INC . 'functions-wp-shims.php';
require_once WCUS_DEMO_INC . 'functions-core.php';
// require_once WCUS_DEMO_INC . 'functions-blocks.php';
require_once WCUS_DEMO_INC . 'functions-cleanup.php';
require_once WCUS_DEMO_INC . 'functions-template.php';
